...
The p-value is extremely low **`r anova(full_score_model, full_int_mod)[2,6]`**, so between the two, we choose the interaction model to begin narrowing down our predictors.
...
- The test statistic: **`r anova(distance_aic, distance_aic2, test = "F")[2,5]`**
- The distribution of the test statistic under the null hypothesis: F-Distribution with 5 and 4704 DF
- The p-value: **`r anova(distance_aic, distance_aic2, test = "F")[2,6]`**
...
```
- $H_0$: There is a small difference in RSS between the two models.
- The test statistic: **`r anova(distance_aic2, large_param_model, test = "F")[2,5]`**
- The distribution of the test statistic under the null hypothesis: F-Distribution with 23 and 4658 DF
- The p-value: **`r anova(distance_aic2, large_param_model, test = "F")[2,6]`**
- A decision: We reject the null hypothesis at $\alpha = 0.10$ 
